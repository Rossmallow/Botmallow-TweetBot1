...
var band_names = [
  '@REALSEAGULLS AFlockOfSeagulls',
  '@theblackkeys TheBeachBoys',
  '@theblackkeys TheBeachBoys',
  '@theblackkeys TheBeachBoys',
  '@theblackkeys TheBeachBoys',
  '@theblackkeys TheBeachBoys',
  '@bstory BStory',
  '@DangerModeMusic ‏DangerMode',
  '@DangerModeMusic ‏DangerMode',
  '@DangerModeMusic ‏DangerMode',
  '@DangerModeMusic ‏DangerMode',
  ...
  '@DEVO ‏Devo',
  '@DEVO ‏Devo',
  '@Gusbuckets ‏GusJohnson',
  'HOME',
  '@TheJeffBridges ‏JeffBridges',
  'JeffersonStarship',
  '@magicswordmusic MagicSword',
  '@magicswordmusic MagicSword',
  'MichaelNesmith',
  'MichaelNesmith',
  'MichaelNesmith',
  ...
  '@starbomb ‏Starbomb',
  '@starbomb ‏Starbomb',
  '@TWRPband ‏TupperWareRemixParty',
  '@TWRPband ‏TupperWareRemixParty',
  '@TWRPband ‏TupperWareRemixParty',
  '@TWRPband ‏TupperWareRemixParty',
  '@TWRPband ‏TupperWareRemixParty',
  '@VanHalen VanHalen',
  '@alyankovic ‏\"WeirdAl\"Yankovic',
  '@alyankovic ‏\"WeirdAl\"Yankovic',
  '@alyankovic ‏\"WeirdAl\"Yankovic',
  '@alyankovic ‏\"WeirdAl\"Yankovic',
  '@alyankovic ‏\"WeirdAl\"Yankovic',
